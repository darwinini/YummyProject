    ...
    return(
        <div>
            ...
            <div style={{textAlign:"center"}}>
                    <form onSubmit={(e)=>submitHandler(e)} className="table-responsive col-5 px-3 day mx-3 mx-auto">
                        ...
                        <div className='outer'>
                            ...
                            {/* Day 1: Sunday */}        
                            <div className="table-responsive col-l px-3 day mx-3 mx-auto">
                                            ...
                                            <tbody>
                                                {
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type='submit' className='btn btn-outline-info'> Add New Meal </button>
                                                    </div>
                                                }
                                            </tbody>
                                    </table>
...
}//end of NewMeal React Component
